...
Route::group(['middleware' => 'auth'], function(){
    ...
    //Admin
    //middleware was been added. It means that the admin can ONLY use the routes inside
    Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], function(){
        //USER
        Route::get('/users', [UsersController::class, 'index'])->name('users');
        // admin.users
        // prefix=>admin -> this adds a prefic to all URI inside the group, Thus the full URI of the first route is 'admin/users'

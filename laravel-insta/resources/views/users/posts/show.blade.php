            ...
            @if (Auth::user()->id === $post->user->id)
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a href="#" class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#delete-post-{{ $post->id }}">
          ...
          <div class="mt-4">
            ...
            <form action="{{ route('comment.store', $post->id) }}" method="post">
              ...
              <div class="input-group">
                <textarea name="comment_body{{$post->id}}" id="comment-body" rows="1" class="form-control form-control-sm" placeholder="Add a comment...">{{ old('comment_body'.$post->id) }}</textarea>
